for(int s=m;s;s=(s-1)&m) // Decreasing order of submasks of m
for (int s=0;s=s-m&m;) 	 // Increasing order of submasks of m
//Modulo de hashing int128
...
//pick theorem: Pick: A=I+B/2-1  (area, points inside, points on border)
//generador random de int en rango [L,R], se puede cambiar por double/ll
